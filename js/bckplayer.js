...
var Player = Class.create(Sprite, {
    ...
    onenterframe: function() {
        ...
        if (map.hitTest(player.x + 16, player.y + scala)==false){
            this.jump = false;
            this.yy += 0.6;
        }else{
            this.jump = true;
        ...
        if (map.hitTest(player.x+16,player.y+scala)){
            this.y = Math.floor(this.y / scala) * scala;
        }

        /**/
        if (map.hitTest(player.x+16,player.y)){
            this.y = Math.floor(this.y / scala) * scala + scala - 1;
        ...
        if (map.hitTest(player.x,player.y+16))
            this.x = Math.floor(this.x / scala) * scala + scala - 2;

        if (map.hitTest(player.x+scala,player.y+16))
            this.x = Math.floor(this.x / scala) * scala;
